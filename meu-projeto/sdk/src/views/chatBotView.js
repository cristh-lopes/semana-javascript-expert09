...
export class ChatbotView {
  ...
  #renderBotMessageHTML(text, renderMarkdown = true) {
    return `
            ...
            }" class="ewcb-avatar" alt="Bot Avatar" />
            <div class="ewcb-message-content">${
              renderMarkdown ? marked.parse(text) : text
            }</div>
        `;
  }
  ...
  #setHeader() {
    ...
    this.#header.querySelector("#ewcb-chatbot-name").textContent =
